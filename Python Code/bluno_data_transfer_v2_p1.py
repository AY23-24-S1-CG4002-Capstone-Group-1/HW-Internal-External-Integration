...
BLUNO_GLOVE_PLAYER_1_MAC_ADDRESS = "D0:39:72:C8:57:2E"
...
class BlunoGlove:
    ...
    def connectToBLEGlove(self):
        ...
        try:
            ...
            self.connPacketReceived = False
            self.connected = False
            print("UNABLE TO CONNECT TO PLAYER 1 GLOVE")
            raise Exception
                ...
                while not self.helloPacketReceived:
                    try:
                        while True:
                            ...
                            #         print("HELLO PACKET RECEIVED FROM PLAYER 1 GLOVE")
                            #     elif not self.connPacketReceived:
                            #         self.connPacketReceived = True
                            #         print("CONN PACKET RECEIVED FROM PLAYER 1 GLOVE")
                            #     elif not self.connected:
                            #         print("PLAYER 1 GLOVE CONNECTED")
                            #         self.connected = True
...
class BlunoGun:
        ...
        while True:
            ...
            while not (self.helloPacketReceived and self.connPacketReceived):
                try:
                    ...
                    print(e)
                    print("PLAYER 1 GUN DISCONNECTED")
    ...
    def connectToBLEGun(self):
        ...
        try:
            ...
            print("UNABLE TO CONNECT TO PLAYER 1 GUN")
            self.helloPacketReceived = False
            self.connPacketReceived = False
            self.connected = False
            self.connectToBLEGun()
                ...
                if (len(self.byte_array) >= 20):
                    ...
                    if (checksum_value != 0):
                        ...
                        if (tuple_data2[1] == ACK_PACKET_ID):
                            ...
                            if (self.parent.helloPacketReceived == False):
                                print("GUN: Hello Packet from Relay -> Bluno sent successfully")
                                self.parent.helloPacketReceived = True
                                self.parent.connPacketReceived = False
                            elif (self.parent.connPacketReceived == False):
                                print("GUN: Conn Packet from Relay -> Bluno sent successfully")
                                self.parent.helloPacketReceived = True
                                self.parent.connPacketReceived = True
...
class BlunoVest:
        ...
        while True:
            ...
            while not (self.helloPacketReceived and self.connPacketReceived):
                try:
                    ...
                    self.peripheral.disconnect()
                    print(e)
                    print("PLAYER 1 VEST DISCONNECTED")
                    self.helloPacketReceived = False
                    self.connPacketReceived = False
                    self.connected = False
                    self.error_count = 0
    ...
    def connectToBLEVest(self):
        ...
        try:
            ...
            print("UNABLE TO CONNECT TO PLAYER 1 VEST")
            self.helloPacketReceived = False
            self.connPacketReceived = False
            self.connected = False
            self.connectToBLEVest()
                ...
                if (len(self.byte_array) >= 20):                    
                    ...
                    if (checksum_value != 0):
                        ...
                        if (tuple_data3[1] == ACK_PACKET_ID):
                            if (self.parent.helloPacketReceived == False):
                                print("HELLO PACKET RECEVIED FROM PLAYER 1 VEST")
                                self.parent.helloPacketReceived = True
                                self.parent.connPacketReceived = False
                            elif (self.parent.connPacketReceived == False):
                                print("CONN PACKET RECEIVED FROM PLAYER 1 VEST")
                                self.parent.helloPacketReceived = True
                                self.parent.connPacketReceived = True
